...
$(function () {
    ...
    Zepto(".ui-delete-dev").unbind('singleTap').bind("singleTap",function(){
    ...
    function getErrorDevice(isMerge, _id, isNeed) {
       ...
       // var skip = $("#mydevicelist").children('li').length;
        ...
        $.ajax({
            ...
            data: {'room_id': room_id, 'room_skip': my_skip, 'room_limit': 10, 'token': token},
            dataType: "json",
            beforeSend: function () {
                loading = true;
                if (isNeed) {
